...
//		}
//		
//		public PseudoField(int rows, int columns, int maxShipSize)
//		{	
...
//			Grid.SetRow(bomb.Image, row);
//			Grid.SetColumn(bomb.Image, column);
//			Children.Add(bomb.Image);
//		}
//		
